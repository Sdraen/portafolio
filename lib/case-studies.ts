...
export const caseUi: Record<Locale, {
  ...
  es: { navAria: "Navegación del proyecto", back: "Volver al portafolio", available: "Disponible para oportunidades", caseStudy: "CASO DE ESTUDIO", preview: "Vista de", highlights: "Aspectos destacados", interface: "INTERFAZ", data: "DATOS", role: "ROL", context: "CONTEXTO", stack: "STACK", challengeLabel: "01 / EL DESAFÍO", challengeTitle: "Entender antes de construir.", solutionLabel: "02 / LA SOLUCIÓN", solutionTitle: "Un producto completo, no solo una interfaz.", resultLabel: "03 / EL RESULTADO", resultTitle: "Una base útil y preparada para evolucionar.", similarChallenge: "¿TIENES UN DESAFÍO SIMILAR?", ctaLine1: "Conversemos sobre", ctaLine2: "tu próximo producto.", write: "Escríbeme" },
  en: { navAria: "Project navigation", back: "Back to portfolio", available: "Available for opportunities", caseStudy: "CASE STUDY", preview: "Preview of", highlights: "Key highlights", interface: "INTERFACE", data: "DATA", role: "ROLE", context: "CONTEXT", stack: "STACK", challengeLabel: "01 / THE CHALLENGE", challengeTitle: "Understand before building.", solutionLabel: "02 / THE SOLUTION", solutionTitle: "A complete product, not just an interface.", resultLabel: "03 / THE OUTCOME", resultTitle: "A useful foundation built to evolve.", similarChallenge: "HAVE A SIMILAR CHALLENGE?", ctaLine1: "Let's discuss", ctaLine2: "your next product.", write: "Contact me" },
  pt: { navAria: "Navegação do projeto", back: "Voltar ao portfólio", available: "Disponível para oportunidades", caseStudy: "ESTUDO DE CASO", preview: "Vista de", highlights: "Destaques", interface: "INTERFACE", data: "DADOS", role: "FUNÇÃO", context: "CONTEXTO", stack: "STACK", challengeLabel: "01 / O DESAFIO", challengeTitle: "Entender antes de construir.", solutionLabel: "02 / A SOLUÇÃO", solutionTitle: "Um produto completo, não apenas uma interface.", resultLabel: "03 / O RESULTADO", resultTitle: "Uma base útil e pronta para evoluir.", similarChallenge: "TEM UM DESAFIO PARECIDO?", ctaLine1: "Vamos conversar sobre", ctaLine2: "seu próximo produto.", write: "Fale comigo" },
  fr: { navAria: "Navigation du projet", back: "Retour au portfolio", available: "Disponible pour des opportunités", caseStudy: "ÉTUDE DE CAS", preview: "Aperçu de", highlights: "Points forts", interface: "INTERFACE", data: "DONNÉES", role: "RÔLE", context: "CONTEXTE", stack: "STACK", challengeLabel: "01 / LE DÉFI", challengeTitle: "Comprendre avant de construire.", solutionLabel: "02 / LA SOLUTION", solutionTitle: "Un produit complet, pas seulement une interface.", resultLabel: "03 / LE RÉSULTAT", resultTitle: "Une base utile et prête à évoluer.", similarChallenge: "VOUS AVEZ UN DÉFI SIMILAIRE?", ctaLine1: "Parlons de", ctaLine2: "votre prochain produit.", write: "Écrivez-moi" },
}
